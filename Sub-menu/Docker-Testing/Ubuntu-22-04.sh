...
BLUE="\e[34m"
ENDCOLOR="\e[0m"
SCRIPTNAME="Ubuntu-22.04"

# Script Auto Self Update
echo -e "${BLUE}Script $SCRIPTNAME Updating${ENDCOLOR}"
VERSION="0.0.1"
SCRIPT_URL='https://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@raw.githubusercontent.com/rune004/Scripts/main/BASH-Script/Docker-Testing/Ubuntu-22-04.sh'
SCRIPT_DESCRIPTION=""
...
docker run -i -d --name="$SCRIPTNAME" ubuntu:22.04
