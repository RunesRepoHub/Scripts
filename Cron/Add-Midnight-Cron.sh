...
DEB_PACKAGE_NAME="python2.7 python-dev libssl-dev"
 ...
 if cat /etc/*release | grep ^NAME | grep CentOS; then
    ...
    dialog --backtitle "$scriptname - Version $version" --title " $me " --prgbox "Remove Midnight-Midget Template" "rm midnight-midget.sh" 30 60
    ...
    # Setup cron settings
    dialog --backtitle "$scriptname - Version $version" --title " $me " --prgbox "Crontab" "crontab -l > file; echo '00 00 * * * ruby /opt/Scripts/midnight-midget.sh >/dev/null 2>&1' >> file; crontab file"
